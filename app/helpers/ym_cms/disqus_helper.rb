module YmCms::DisqusHelper
  ...
  def disqus_latest
    url = "http://#{disqus_shortname}.disqus.com/recent_comments_widget.js?num_items=3&hide_avatars=1&avatar_size=32&excerpt_length=200"
